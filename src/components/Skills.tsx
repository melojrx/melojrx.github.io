...
export const Skills = () => {
  ...
  [t('skills.categories.versionControl')]: [
...
return (
    <section id="skills" className="relative py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-foreground/70 max-w-2xl mx-auto mb-10 sm:mb-12 lg:mb-14 text-sm sm:t{t('skills.title')}ding-relaxed">
