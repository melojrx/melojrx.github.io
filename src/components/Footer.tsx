...
export const Footer = () => {
  return (
  <footer className="py-12 bg-secondary/60 border-t border-border/40 mt-20 relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 text-center text-foreground/80 space-y-6">
        ...
        <p className="mt-8 flex items-center justify-center gap-3 text-xs text-foreground/55">
          <img src="/logo-white.svg" alt="Logo" className="h-5 w-5 md:h-6 md:w-6" />
